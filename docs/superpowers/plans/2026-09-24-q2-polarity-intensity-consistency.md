...
- [x] **Step 1: Write failing configuration, loss, and train-wiring tests.**
...
- [x] **Step 3: Implement the minimal compatible change.**
...
- [x] **Step 1: Write the one-variable configuration.**
...
Result: fixed `0.10` consistency loss reduced clean macro-F1 to `0.6054532088`, reduced Neutral F1 and violated the MAE guard. The next pre-registered candidate is MAG-lite from the exploration portfolio; the consistency coefficient will not be tuned.
